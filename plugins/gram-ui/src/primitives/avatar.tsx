...
import { MediaSourceBadge } from '../components/media-source-badge.js';
...
export function Avatar({ url, blurUrl, initial, color, size = 'medium', className = '', source }: AvatarProps) {
