...
function testCRC32() {
    console.log('Test: CRC32 computation');
    ...
    console.log('  CRC32 basic: OK');
}

function testSchemaParsing() {
    console.log('Test: Schema parsing');
    ...
    console.log(`  Parsed: ${schema.types.size} types, ${schema.constructors.size} constructors, ${schema.functions.size} functions`);
}

function testRegistry() {
    console.log('Test: Schema registry');
...
function testConstructorIdComputation() {
    console.log('Test: Constructor ID computation');
    ...
    console.log('  Constructor IDs: OK');
}
...
function testDeserialization() {
    console.log('Test: Deserialization');
    const registry = new SchemaRegistry(TEST_SCHEMA);
    const serializer = new SchemaSerializer(registry);
